...
const MODULE_DESCRIPTIONS = Object.freeze({
  ...
  market: '선택한 사업안의 시장 규모와 가격을 공개 통계·공시로 조사하고, 그 근거로 BM 캔버스 9칸을 채웁니다.',
...
export function ProjectOverviewPage() {
  ...
  return <section className="pipeline-overview" aria-labelledby="project-overview-title">
    <div className="pipeline-page-heading"><p>7단계 파이프라인</p><h2 id="project-overview-title">프로젝트 개요</h2><span>각 모듈은 독립 상태로 표시되며 상태와 관계없이 언제든 화면을 열 수 있습니다.</span></div>
