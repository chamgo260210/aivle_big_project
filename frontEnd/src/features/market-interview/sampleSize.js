 ...
 *
 * ⚠ 아래 세 상수는 7문항 시절의 어림이다. 9문항 + 파고들기로 답이 길어졌고
 * (`runner.MAX_COMPLETION_TOKENS` 1200 → 2000), 코딩이 2패스가 되면서 호출도 늘었다.
 * **유료 1판의 실측치로 다시 잡아야 한다** — 지금은 짧게 잡히는 쪽으로 틀려 있다.
 */
const CELLS_PER_SECOND = 3;
/** 코드북 1회 + 배정 ⌈n/40⌉회. 전수를 프롬프트에 넣으므로 표본에 따라 늘어난다. */
const CODING_SECONDS_PER_PERSON = 0.6;
const CODING_BASE_SECONDS = 20;
