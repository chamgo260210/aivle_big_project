...
function GettingStartedRail({ projects, newest, location, writeRestriction }) {
  ...
  return <aside className="getting-started-rail" aria-labelledby="workspace-getting-started-title"><p>7단계 파이프라인</p><h2 id="workspace-getting-started-title">모든 모듈을 바로 확인할 수 있습니다</h2><ol>{items.map((item, index) => {
...
export default function WorkspaceHomePage() {
  ...
  return <div className="workspace-home"><PageHeader eyebrow="Personal workspace" title={`안녕하세요, ${displayName(user)}님`} description="최근 프로젝트와 7단계 파이프라인의 모듈 상태를 확인하세요." />
