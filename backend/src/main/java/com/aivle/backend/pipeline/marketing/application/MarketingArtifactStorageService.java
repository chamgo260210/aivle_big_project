...
public class MarketingArtifactStorageService {
    ...
    public String storeGeneratedJpeg(byte[] content) {
        ...
        try {
            ValidatedUpload validated = uploadPolicy.validate(
                "generated-marketing-image.jpg",
                "image/jpeg",
            ...
            if (
                ...
                || !stored.checksumSha256()
                    .equals(validated.checksumSha256())
            ) {
                throw new IOException(
                    "stored marketing image integrity mismatch"
                );
            }
            ...
            throw new IllegalStateException(
                "marketing image storage failed",
                failure
            );
        }
    }
